...
const LeftSideBar: React.FC<LeftSideBarProps> = ({ isAdmin }) => {
  ...
  return (
    <section className="sticky left-0 top-0 z-20 flex h-screen w-fit flex-col justify-between  overflow-auto border-r border-r-dark-4 bg-white pb-10 pt-20 max-md:hidden">
